...
public interface BaseballCards {
  ...
  void storeCard(String cardId, String playerId, int publicationYear, String collection, CardStatus state,
  ...
  Loan lendCard(String loanId, String entityId, String cardId, String workerId, LocalDate date,
  ...
  int timeToBeCataloged(String cardId, int boxPreparationTime, int cardCatalogTime)
